...
--@localization(locale="ruRU", namespace="GridCore", format="lua_additive_table")@
------------------------------------------------------------------------
--	GridFrame
...
--@localization(locale="ruRU", namespace="GridStatus", format="lua_additive_table")@
------------------------------------------------------------------------
--	GridStatusAbsorbs

--@localization(locale="ruRU", namespace="GridStatusAbsorbs", format="lua_additive_table")@
------------------------------------------------------------------------
--	GridStatusAggro
...
--@localization(locale="ruRU", namespace="GridStatusHeals", format="lua_additive_table")@
------------------------------------------------------------------------
--	GridStatusHealth
...
--@localization(locale="ruRU", namespace="GridStatusResurrect", format="lua_additive_table")@
------------------------------------------------------------------------
--	GridStatusTarget
